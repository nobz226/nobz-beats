  ...
  return (
    <>
      ...
      <button
        ...
        onClick={toggleVisible}
        ref={toggleRef}
          className={`playlist-toggle hidden lg:flex fixed right-2 top-1/2 z-[1011] -translate-y-1/2 items-center justify-center bg-white/5 text-white rounded-md border border-white/[0.06] hover:bg-white/10 transition-all px-3 py-2 ${highlight ? 'ring-4 ring-white/30 pulse-highlight' : ''}`}
      >
