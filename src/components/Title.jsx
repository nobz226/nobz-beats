...
export default function Title() {
  return (
    <h1 
      className="fixed left-4 md:left-[7.8125rem] top-[20%] md:top-[30%] whitespace-nowrap text-[2.5rem] md:text-[4.6875rem] font-normal tracking-wider z-[1010] pointer-events-none m-0 p-1 font-rubik opacity-0 text-transparent bg-clip-text"
      style={{
